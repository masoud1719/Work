...
namespace Work.Data
{
    public class SATM
    {
        ...
        public SATM(string zone, double topDepth, double bottomDepth, double thickness, double kavg, double phiavg, double pce, double swe, double pcMax, double swir)
        {
            Zone = zone;
            TopDepth = topDepth;
        ...
        public static SATM GetModel(String excelRow)
        {
            string[] elements = excelRow.Split(',');
            return new SATM(elements[1], Double.Parse(elements[2]), Double.Parse(elements[3]),
        ...
        public static List<SATM> GetModelsFromExcelFile(String filePath)
        {
            ...
            using (var package = new OfficeOpenXml.ExcelPackage(file))
            {
                ...
                List<SATM> results = new List<SATM>();
        ...
        public static List<SATM> GetinitialDatas()
        {
            List<SATM> models = new List<SATM>();
